...
class page:
	...
	def get_body(self,soup):
		try:
			article_body = soup.find('div',attrs={"class",'entry-content clearfix'}).find_all('p')
			body_text = ''
	...
	def get_tag(self,soup):	
		try:
			related_tag = soup.find('span',attrs={"class",'cat-links'}).find_all('a')
			tags =[]
	...
	#spidering('https://latesthackingnews.com/2018/04/19/localocablox-rumbled-after-scraping-48-million-users-data-and-accidently-leaving-it-open-to-the-public/')